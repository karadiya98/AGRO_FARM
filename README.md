...
2] This is page if clicked on USER  
<div >
  <img src="AGRO IMAGES/2.png" width="100%">
</div>


3] This is login page before any order  
<div >
  <img src="AGRO IMAGES/3.png" width="100%">
</div>


4] This is product detail page  if clicked any product   
<div >
  <img src="AGRO IMAGES/4.png" width="100%">
</div>


5] This is add to cart  page  
<div >
  <img src="AGRO IMAGES/5.png" width="100%">
</div>


6] This is order page  
<div >
  <img src="AGRO IMAGES/6.png" width="100%">
</div>


7] This is VIEW tracking page if clicked on view of any particular order  
<div >
  <img src="AGRO IMAGES/7.png" width="100%">
</div>


8] This is BILL , user download easily if the status shows <h3>DELIVERED</h3> other wise <h3>NO</h3> page  
<div >
